...
from ecoindex.models.enums import Language
from ecoindex.utils.files import get_translations
...
class Report:
    ...
    def create_report(self) -> None:
        self.create_histogram(
            property="requests",
            target=target_req,
            global_median=median_req,
        )
        self.create_histogram(
            property="size",
            target=target_size,
            global_median=median_size,
        )
        self.create_histogram(
            property="nodes",
            target=target_dom,
            global_median=median_dom,
        )
